...
struct PowerstageParameters
{
    ...
    float max_current_A = 5.0f; // Overcurrent threshold (X-NUCLEO-IHM07M1 max peak)
    ...
    {
        return (adc_vref_V / static_cast<float>(adc_counts_fs)) / (shunt_resistor_ohm * current_amp_gain);
    }
