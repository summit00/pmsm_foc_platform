...
TEST_CASE("Space Vector Modulation Min-Max method")
{
    ...
    SECTION("balanced three-phase voltages")
    {
        ...
        auto [va_out, vb_out, vc_out] = spaceVectorModulation(50.0f, 50.0f, 50.0f);
    ...
    SECTION("single phase at maximum")
    {
        ...
        auto [va_out, vb_out, vc_out] = spaceVectorModulation(100.0f, -50.0f, -50.0f);
    ...
    SECTION("symmetrical three-phase offset")
    {
        ...
        auto [va_out, vb_out, vc_out] = spaceVectorModulation(75.0f, -25.0f, -50.0f);
    ...
    SECTION("negative voltage range")
    {
        ...
        auto [va_out, vb_out, vc_out] = spaceVectorModulation(-60.0f, -100.0f, -80.0f);
    ...
    {
        auto [va_out, vb_out, vc_out] = spaceVectorModulation(0.0f, 0.0f, 0.0f);
    ...
    SECTION("typical three-phase sine wave snapshot")
    {
        ...
        auto [va_out, vb_out, vc_out] = spaceVectorModulation(86.6f, -43.3f, -43.3f);
