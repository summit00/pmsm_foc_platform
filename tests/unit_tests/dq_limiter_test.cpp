...
TEST_CASE("DQ Limiter with saturation")
{
    ...
    SECTION("no saturation when magnitude is within limit")
    {
        ...
        auto [d_sat, q_sat] = DQLimiter::applyLimit(3.0f, 4.0f, 10.0f);
    ...
    SECTION("no saturation at exact limit")
    {
        ...
        auto [d_sat, q_sat] = DQLimiter::applyLimit(6.0f, 8.0f, 10.0f);
    ...
    SECTION("saturation when magnitude exceeds limit")
    {
        ...
        auto [d_sat, q_sat] = DQLimiter::applyLimit(6.0f, 8.0f, 5.0f);
    ...
    SECTION("saturation with equal d and q components")
    {
        ...
        auto [d_sat, q_sat] = DQLimiter::applyLimit(5.0f, 5.0f, 5.0f);
    ...
    SECTION("mixed sign components with saturation")
    {
        ...
        auto [d_sat, q_sat] = DQLimiter::applyLimit(6.0f, -8.0f, 7.5f);
    ...
    {
        // mag_ref = 0, x_max = 10
        auto [d_sat, q_sat] = DQLimiter::applyLimit(0.0f, 0.0f, 10.0f);
    ...
    {
        // mag_ref = 5, x_max = 10
        auto [d_sat, q_sat] = DQLimiter::applyLimit(5.0f, 0.0f, 10.0f);
    ...
    SECTION("only d component non-zero with saturation")
    {
        ...
        auto [d_sat, q_sat] = DQLimiter::applyLimit(15.0f, 0.0f, 5.0f);
    ...
    SECTION("only q component non-zero with saturation")
    {
        ...
        auto [d_sat, q_sat] = DQLimiter::applyLimit(0.0f, 20.0f, 8.0f);
    ...
    SECTION("very small limit value")
    {
        ...
        auto [d_sat, q_sat] = DQLimiter::applyLimit(3.0f, 4.0f, 0.1f);
    ...
    SECTION("large magnitude with saturation")
    {
        ...
        auto [d_sat, q_sat] = DQLimiter::applyLimit(300.0f, 400.0f, 250.0f);
