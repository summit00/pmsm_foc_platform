...
void HAL_ADC_MspInit(ADC_HandleTypeDef* adcHandle)
{
  ...
  */
    ...
    PA2     ------> ADC1_INP14
    */
    GPIO_InitStruct.Pin = Iu_Pin|Iw_Pin;
  ...
  */
    ...
    PA1     ------> ADC2_INP1
    */
    GPIO_InitStruct.Pin = DCBus_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(DCBus_GPIO_Port, &GPIO_InitStruct);
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* adcHandle)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PA2     ------> ADC1_INP14
    */
    HAL_GPIO_DeInit(GPIOA, Iu_Pin|Iw_Pin);
  ...
  /* USER CODE END ADC2_MspDeInit 0 */
    ...
    PA1     ------> ADC2_INP1
    */
    HAL_GPIO_DeInit(DCBus_GPIO_Port, DCBus_Pin);
